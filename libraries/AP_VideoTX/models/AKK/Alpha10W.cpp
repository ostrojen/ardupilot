...
PowerLevel Alpha10W::power_levels[VTX_MAX_POWER_LEVELS] = {
    { 0,    1000,  14, 7    },
    { 1,    3000,  30, 22   },
    { 2,    5000,  33, 25   },
    { 3,    7000,  35, 32   },
...
const char* Alpha10W::band_names[VTX_MODEL_BANDS] =  {"A","b","E","F","r","P","L","U","O","X"};

const uint16_t Alpha10W::VIDEO_CHANNELS[VTX_MODEL_BANDS][VTX_MODEL_CHANNELS] = {
...
const uint16_t Alpha10W::max_power = 10000;
